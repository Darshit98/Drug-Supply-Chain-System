...
public class AdministerDrugToPatientClinicJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblPatient.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblMedicineCode.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblDoseNumber.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblManufactureDate.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblBatchNumber.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblArm.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        lblArm.setForeground(new java.awt.Color(0, 51, 102));
        lblArm.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblArm.setText("Arm");

        lblInjectionStatus.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        lblGivenBy.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(14, 14, 14)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtManufactureDate, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                                            .addComponent(comboBoxMedicineCodeList, 0, 179, Short.MAX_VALUE)
                                            .addComponent(comboBoxBrand, 0, 179, Short.MAX_VALUE)
                                            .addComponent(comboBoxArm, 0, 179, Short.MAX_VALUE))
                                        .addGap(338, 338, 338))))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(comboBoxStatus, 0, 179, Short.MAX_VALUE))
                                        .addGap(269, 269, 269))
